...
/**
 * An Enemy object that uses "Bryce.jpg" with 1 health and moderate speed.
 */
public class EnemyBryceMinions extends Enemy {

    public EnemyBryceMinions(double p, GameState state){
        super(p, state, 0.005, 1);
    }
